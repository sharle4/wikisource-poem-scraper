...
def clean_author_name(raw_name: str) -> str:
    """
    Nettoie et normalise un nom d'auteur extrait de Wikisource.
    """
    ...
    # Suppressions des préfixes
    name = re.sub(r"^[Aa]uteur\s*:\s*", "", name)
    
    # Suppressions des mentions inutiles
    ...
    # Fix missing spaces around punctuations: ";Joris" -> "; Joris"
